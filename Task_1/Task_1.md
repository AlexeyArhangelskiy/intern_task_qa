...
Карточки товара имеют парfметр _Оперативной памяти_, но фильтрах отсутствует такой параметр.
...
Фильтр цена до не имеет значка валюты ₽

## Ожидаемое поведение

Сумма написана с указанием валюты ₽
...
Орфографическая ошибка в фильтре Состояние _Требует ремонт_

## Ожидаемое поведение

Фильтр с названием _Требуется ремонт_
...
Ошибки в отрожение адреса у карточек товара

1. Пропущено слово ул.
2. Пропущено указания времени от станции
3. Пропущено указание города

## Ожидаемое поведение

В соответсвии с общим дизайном
...
Фотография телефона не соответсвует описанию, на фотографии IPhone, a не Samsung

## Ожидаемое поведение

Описание товара и его фотография соответсвуют ожиданию
...
![Screenshot](./img/bug_namePhone.png)
